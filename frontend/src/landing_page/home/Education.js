...
function Education() {
    return ( 
        <div className="container mt-5">
         <div className="row">
            <div className="col-6">
               <img src="/media/images/education.svg" alt="img" style={{width:'70%'}} />
            </div>
            ...
            <div className="col-6">
                ...
                <p> 
                   ...
                   the world covering everything from the basics to advance trading.  
                </p>
                <a href="" style={{textDecoration: 'none'}}>Versity <i className='fa fa-long-arrow-right'></i> </a>

                <p className='mt-5'> 
                    TrandingQ&A, the most active trading and investment community in 
